...
void show_help(void) {
    ...
    printf("  SHOW ALL SORT BY ID       - Display all records sorted by ID.\n");
    printf("  SHOW ALL SORT BY MARK     - Display all records sorted by mark.\n");
    ...
    printf("  QUERY                     - Search for records (by ID/name/etc.).\n");
